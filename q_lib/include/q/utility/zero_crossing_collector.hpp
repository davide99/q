...
namespace cycfi::q
{
   ...
   public:
      ...
      struct info
      {
         ...
         float             _width = 0.0f;
                           ...
                           zero_crossing_collector(float hysteresis, std::uint32_t window);
   ...
   namespace detail
   {
    ...
    inline zero_crossing_collector::zero_crossing_collector(float hysteresis, std::uint32_t window)
